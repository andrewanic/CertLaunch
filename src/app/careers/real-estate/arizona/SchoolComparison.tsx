...
const schools: School[] = [
  {
    name: 'RealEstateU',
    url: 'https://realestateu.com/arizona-real-estate-license-course/',
    rating: 4.6,
    ratingSource: 'BBB',
    format: 'Online self-paced (audio)',
    access: '12-month access',
    features: ['Audio-based course', 'Flexible schedule', 'Start instantly'],
    badge: 'Best Value',
    ...
    packages: [
      {
        ...
        price: 199,
        discountPrice: null,
        includes: ['90-hour pre-license course', '6-hour contract writing course', 'Audio lessons'],
      },
      {
    ...
    packages: [
      {
        ...
        price: 489,
        discountPrice: null,
        includes: ['96-hour pre-license course', 'Audio narration', 'Instructor support'],
      },
      {
        name: 'Premium',
        price: 599,
        discountPrice: null,
        includes: ['Everything in Basic', 'AI virtual instructor', 'PrepAgent exam prep', 'Live webinars'],
      },
    ],
  },
  {
    name: 'Arizona School of Real Estate & Business (ASREB)',
    url: 'https://www.asreb.com/real-estate/pre-licensing/',
    rating: 4.9,
    ratingSource: 'Local Leader',
    format: 'Online, Livestream, Classroom',
    access: '6-month access',
    features: ['55+ years in AZ', 'Mix & match formats', 'Pass or Don\'t Pay Guarantee'],
    badge: 'Local Leader',
    ...
    packages: [
      {
        ...
        price: 699,
        discountPrice: null,
        includes: ['90-hr pre-license + 6-hr contract', 'Employment opportunities', 'Mix & match formats'],
      },
      {
        name: 'Career Start',
        price: 929,
        discountPrice: null,
        includes: ['Everything in Basic', 'Exam Prep Crammer', 'CompuCram exam prep', 'Flashcards'],
      },
      {
        name: 'Set For Success',
        price: 1049,
        discountPrice: null,
        includes: ['Everything in Career Start', '18-hour CE package', 'Math review', 'Broker workshop'],
      },
    ],
  },
  {
    name: 'The CE Shop',
    url: 'https://www.theceshop.com/arizona/pre-licensing/az-salesperson-pre-licensing-cost',
    rating: 4.5,
    ...
    packages: [
      {
        ...
        price: 659,
        discountPrice: null,
        includes: ['90-hr pre-license + 6-hr contract', 'Exam Prep Edge', 'Pass guarantee'],
      },
      {
        name: 'Value Package',
        price: 729,
        discountPrice: null,
        includes: ['Everything in Standard', 'Business building courses'],
      },
      {
        name: 'Premium Package',
        price: 889,
        discountPrice: null,
        includes: ['Everything in Value', '24-hr post-license CE', '14-hr first renewal package'],
      },
    ],
  },
  {
    name: 'Kaplan Real Estate Education',
    url: 'https://www.kapre.com/real-estate/arizona/licensing-courses/p/az-packages',
    rating: 4.2,
    ratingSource: 'Student Reviews',
    format: 'Online + Live Online',
    access: '6-month access',
    features: ['National brand', 'Live Online Learning Hub', 'Exam-focused'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 489,
        discountPrice: null,
        includes: ['96-hour complete package', 'Exam prep', 'Live Online Learning Hub'],
      },
      {
        name: 'Career Launcher',
        price: 889,
        discountPrice: null,
        includes: ['Everything in Exam Prep Package', 'Real Estate Accelerator boot camp'],
      },
    ],
  },
  {
    name: 'Hogan School of Real Estate',
    url: 'https://hoganschool.com/real-estate/pre-licensing',
    rating: 4.8,
    ratingSource: 'Local Reputation',
    format: 'Online, Livestream, Classroom',
    access: '6-month access',
    features: ['Southern AZ leader', '50+ years experience', 'Mix & match formats'],
    badge: 'Tucson Favorite',
    ...
    packages: [
      {
        ...
        price: 699,
        discountPrice: null,
        includes: ['90-hr pre-license + 6-hr contract', 'Mix & match formats', 'Instructor support'],
      },
      {
        name: 'Career Start Package',
        price: 929,
        discountPrice: null,
        includes: ['Everything in Basic', 'Exam Prep Crammer', 'CompuCram exam prep'],
      },
      {
        name: 'Set For Success Package',
        price: 1049,
        discountPrice: null,
        includes: ['Everything in Career Start', '18-hr CE package', 'Math review', 'Broker workshop'],
      },
    ],
  },
  {
    name: 'American Realty Academy',
    url: 'https://www.americanrealtyacademy.com/enroll/online-arizona-real-estate-school/',
    rating: 4.7,
    ratingSource: 'Local Reviews',
    format: 'Online self-paced',
    access: '6-month access',
    features: ['Phoenix-based', 'Highly rated online program', 'Live group tutoring available'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 489,
        discountPrice: null,
        includes: ['90-hr pre-license + 6-hr contract', 'Instructor support'],
      },
      {
        name: 'Plus Plan',
        price: 629,
        discountPrice: null,
        includes: ['Everything in Core', 'Live group tutoring', 'Study Success Bundle'],
      },
      {
        name: 'Career Plan',
        price: 699,
        discountPrice: null,
        includes: ['Everything in Plus', 'Pass Guarantee', 'First license renewal'],
      },
    ],
  },
];
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            <h2 className="font-display font-bold text-2xl text-neutral-900 mb-2">
              Best Real Estate Schools in Arizona
            </h2>
            <p className="text-neutral-500 text-sm">
              All {schools.length} schools are Arizona ADRE-approved. {sortLabels[sortBy]}.
            </p>
          </div>
          <div className="flex items-center gap-2">
