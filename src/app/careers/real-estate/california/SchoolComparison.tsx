...
const schools: School[] = [
  {
    name: 'RealEstateU',
    url: 'https://realestateu.com/california-real-estate-license-online/',
    rating: 4.6,
    ratingSource: 'BBB',
    format: 'Self-paced online',
    access: '6-month access',
    features: ['30-day money-back guarantee', 'Audio course included', '100,000+ students'],
    badge: 'Best Value',
    ...
    packages: [
      {
        ...
        price: 99,
        discountPrice: 79,
        includes: ['135-hour pre-license course', 'On-demand video lessons', 'State-approved certificate'],
      },
      {
        name: 'Course + Study Guide + Start Earning',
        price: 277,
        discountPrice: 222,
        includes: ['Everything in Course Only', 'Exam study guide', 'Start earning resources'],
      },
      {
        name: 'Course + Study Guide + Agent Success',
        price: 655,
        discountPrice: 524,
        includes: ['Everything in previous package', 'Agent success program', 'Career coaching'],
      },
    ],
  },
  {
    name: 'California School of Real Estate',
    url: 'https://www.easy2pass.com/',
    rating: 4.8,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: '1-year access',
    features: ['CA-only school since 1941', '200% money-back guarantee', '300,000+ students'],
    badge: 'Top Rated',
    ...
    packages: [
      {
        name: 'Sales Agent License',
        price: 99,
        discountPrice: null,
        includes: ['135-hour course', 'PowerPrep exam prep', 'Practice exams', 'Audio guides', 'Flashcards'],
      },
    ],
  },
  {
    name: 'License Solution',
    url: 'https://licensesolution.com/california-real-estate-agent-license/',
    rating: 4.5,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: 'Varies',
    features: ['Permanent sale prices', 'Audio version available', 'Crash course option'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 99,
        discountPrice: null,
        includes: ['135-hour pre-license course'],
      },
      {
        name: 'Silver',
        price: 149,
        discountPrice: null,
        includes: ['Course + audio version', 'State exam prep'],
      },
      {
        name: 'Gold',
        price: 199,
        discountPrice: null,
        includes: ['Everything in Silver', 'Video crash course', 'Exam prep'],
      },
    ],
  },
  {
    name: 'VanEd',
    url: 'https://www.vaned.com/real-estate/california/pre-license',
    rating: 4.3,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: '6-month access',
    features: ['Live customer service', 'CA exam prep available', 'Sponsor #S0656'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        name: '135-Hour Standard',
        price: 110,
        discountPrice: null,
        includes: ['3 required courses (135 hours)', 'Live customer service'],
      },
      {
        name: '135-Hour Plus',
        price: 147,
        discountPrice: null,
        includes: ['Standard package', 'CA exam prep', 'E-book'],
      },
      {
        name: '135-Hour + CE Premium',
        price: 245,
        discountPrice: null,
        includes: ['Plus package', '45-hour first renewal package'],
      },
    ],
  },
  {
    name: 'OnlineEd',
    url: 'https://www.onlineed.com/catalog/California/real-estate/pre-license/salesperson-licensing',
    rating: 4.5,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: '1-year access',
    features: ['Partners with CA Association of Realtors', 'Price match guarantee', 'Instructor access'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 129,
        discountPrice: null,
        includes: ['135-hour course', 'Instructor access'],
      },
      {
        name: 'Standard',
        price: 229,
        discountPrice: null,
        includes: ['Basic package', 'Exam prep', 'First-time pass guarantee'],
      },
      {
        name: 'Premium',
        price: 424,
        discountPrice: null,
        includes: ['Standard package', 'Bound textbooks', 'Math prep book'],
      },
    ],
  },
  {
    name: 'The CE Shop',
    url: 'https://www.theceshop.com/california/pre-licensing/ca-salesperson-pre-licensing-cost',
    rating: 4.4,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: '6-month access',
    features: ['Interactive LEAP platform', 'Pass guarantee', 'Business ebooks'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 139,
        discountPrice: null,
        includes: ['135-hour course', 'Business ebooks', 'Career resources', 'Digital flashcards'],
      },
      {
        name: 'Standard',
        price: 239,
        discountPrice: null,
        includes: ['Basic package', 'Exam prep', 'Pass guarantee'],
      },
      {
        name: 'Value',
        price: 315,
        discountPrice: null,
        includes: ['Standard package', 'Kickstarter professional dev program'],
      },
      {
        name: 'Premium',
        price: 435,
        discountPrice: null,
        includes: ['Value package', 'eTextbook', '45-hour first renewal package'],
      },
    ],
  },
  {
    name: 'Colibri Real Estate',
    url: 'https://www.colibrirealestate.com/real-estate/california/license/',
    rating: 4.3,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online + Livestream',
    access: '6-month access',
    features: ['Live instructor support', 'Pass or Don\'t Pay Guarantee', 'Career resources'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 199,
        discountPrice: null,
        includes: ['135-hour course', 'Live instructor support'],
      },
      {
        name: 'Exam Preparation',
        price: 279,
        discountPrice: null,
        includes: ['The Basics', 'Prep tools', 'Pass or Don\'t Pay Guarantee'],
      },
      {
        name: 'Exam Preparation Plus',
        price: 349,
        discountPrice: null,
        includes: ['Exam Preparation', 'Instructor-led Q&A', 'Live exam cram'],
      },
      {
        name: 'Ultimate Learning',
        price: 459,
        discountPrice: null,
        includes: ['Everything + printed textbook', 'Career-launch resources'],
      },
    ],
  },
  {
    ...
    access: '6-month access',
    features: ['Mobile app access', 'AI course assistant', 'Advanced exam prep'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 199,
        discountPrice: null,
        includes: ['135-hour course', 'PDF study guides'],
      },
      {
        name: 'Deluxe',
        price: 297,
        discountPrice: null,
        includes: ['Basic package', 'AI course assistant', 'Advanced exam prep'],
      },
      {
        name: 'Premium',
        price: 359,
        discountPrice: null,
        includes: ['Deluxe package', 'Live webinars', 'Private tutoring'],
      },
    ],
  },
  {
    name: 'Adhi Schools',
    url: 'https://www.adhischools.com/california-real-estate-pre-licensing-course',
    rating: 4.7,
    ratingSource: 'Google Reviews',
    format: 'Online + Livestream',
    access: 'Varies',
    features: ['CA-only school', 'Active agents as instructors', 'Crash course option'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        name: 'Self-Paced Online Videos',
        price: 299,
        discountPrice: null,
        includes: ['135-hour course', 'Interactive videos', 'Crash course discount'],
      },
      {
        name: 'Livestream Classes',
        price: 499,
        discountPrice: null,
        includes: ['Live Zoom instruction', 'Flexible schedule', 'Make-up classes allowed'],
      },
    ],
  },
  {
    name: 'Kaplan Real Estate',
    url: 'https://www.kapre.com/real-estate/california/licensing-courses/p/ca-salesperson-packages',
    rating: 4.4,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online + Live Online',
    access: '6-month access',
    features: ['Commitment to Pass policy', 'Video prep', 'Audio MP3s'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 399,
        discountPrice: null,
        includes: ['135-hour course', 'Learning Hub', 'Practice questions', 'Exam prep', 'Audio MP3'],
      },
      {
        name: 'Career Launcher',
        price: 699,
        discountPrice: null,
        includes: ['Exam Prep Package', 'Real Estate Accelerator', 'Flashcards', 'Textbooks'],
      },
    ],
  },
  {
    name: 'firsttuesday',
    url: 'https://www.firsttuesday.us/SalesLicensing.cfm',
    rating: 4.6,
    ratingSource: 'Student Reviews',
    format: 'Self-paced online',
    access: '1-year access',
    features: ['CA-only school', 'Video lessons available', 'DRE approved'],
    badge: null,
    badgeColor: '',
    discountCode: null,
    discountPct: null,
    packages: [
      {
        ...
        price: 165,
        discountPrice: null,
        includes: ['135-hour course (3 e-books)', 'Principles, Practice & Legal Aspects'],
      },
      {
        name: 'Video & E-Book Package',
        price: 245,
        discountPrice: null,
        includes: ['135-hour course', 'Video lessons + e-books', 'Principles, Practice & Legal Aspects'],
      },
      {
        name: 'Video & E-Book + Exam Prep',
        price: 354,
        discountPrice: null,
        includes: ['Video & E-Book Package', 'State Exam Training Package', 'Practice exams + prep book'],
      },
    ],
  },
];
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-neutral-500 text-sm">
              All {schools.length} schools are California DRE-approved. {sortLabels[sortBy]}.
            </p>
          </div>
          <div className="flex items-center gap-2">
