    ...
    packages: [
      {
        ...
        includes: ['180-hour TREC-approved course', 'On-demand audio lessons', 'Study at your own pace'],
      },
      {
        name: 'Get Exam Ready',
        price: 377,
        discountPrice: 301.60,
        includes: ['Everything in License Essentials', 'State exam study guide', 'e-Textbook'],
      },
      {
        name: 'The Career Launcher',
        price: 509,
        discountPrice: 407.20,
        includes: ['Everything in Get Exam Ready', 'Agent Success Path course', 'Blueprint to Making $245K/year course'],
      },
    ],
  },
  {
    ...
    packages: [
      {
        ...
        price: 529,
        discountPrice: null,
        includes: ['180-hour course', 'Instructor support', 'Real estate study guides', 'AI tutor'],
      },
      {
      ...
      },
      {
        ...
        price: 729,
        discountPrice: null,
        includes: ['Everything in Exam Prep Plus', 'Printed textbook', 'Career Booster Pack'],
      },
    ],
  },
  {
