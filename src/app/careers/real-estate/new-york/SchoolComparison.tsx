    ...
    packages: [
      {
        ...
        price: 379,
        discountPrice: null,
        includes: ['77-hour pre-license course', '24/7 Student Community'],
      },
      {
        name: 'Exam Prep Package',
        price: 499,
        discountPrice: null,
        includes: ['Everything in Qualifying', 'Live Online Learning Hub', 'Kaplan Commitment (18-mo support)', 'Exam prep: national & NY laws', 'Career Mentor Connect'],
      },
      {
        name: 'Career Launcher',
        price: 849,
        discountPrice: null,
        includes: ['Everything in Exam Prep', 'Video course', 'Drill and Practice QBank', 'Career resources'],
      },
    ],
  },
  {
